defmodule Onion.RoomSession do
  ...
  defp join_room_impl(user_id, mute, deafen, opts, state) do
  ...
  defp deaf_impl(user_id, value, state) do
  ...
  def handle_cast({:join_room, user_id, mute, deafened, opts}, state) do
    join_room_impl(user_id, mute, deafened, opts, state)
  end
