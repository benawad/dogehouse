...
export const customEmojis = [
  ...
  },
  {
    ...
    imageUrl: "/emotes/PepeClown.png",
  },
  {
    name: "Kappa",
    short_names: ["Kap"],
    keywords: ["Kap", "Kappa", "Gray Face"],
    imageUrl: "/emotes/Kappa.png",
  },
  {
    name: "KEKR",
    short_names: ["KEK"],
    keywords: ["KEK", "KEKR"],
    imageUrl: "/emotes/KEKR.png",
  },
  {
    name: "peepoStare",
    short_names: ["Stare"],
    keywords: ["peepo", "Pepe", "Stare"],
    imageUrl: "/emotes/peepoStare.png",
  },
  {
    name: "ComfWee",
    short_names: ["Comfy"],
    keywords: ["Dog", "Doggy", "Puppy"],
    imageUrl: "/emotes/ComfWee.png",
  },
  {
    name: "ZULUL",
    short_names: ["ZULUL"],
    keywords: ["LUL", "African LUL"],
    imageUrl: "/emotes/ZULUL.png",
  },
  {
    name: "SadgeJuice",
    short_names: ["SadgeSit"],
    keywords: ["Sadge", "Peepo", "Pepe", "Drink", "Sit", "Juice"],
    imageUrl: "/emotes/SadgeJuice.png",
  },
  {
    name: "SQUADW",
    short_names: ["SQUADW"],
    keywords: ["Trainwrecks", "SQUAD", "HUH"],
    imageUrl: "/emotes/SQUADW.png",
  },
  {
    name: "peepoSQUAD",
    short_names: ["PepeSQUAD"],
    keywords: ["SQUAD", "HUH"],
    imageUrl: "/emotes/peepoSQUAD.png",
  },
  {
    name: "peepoWeird",
    short_names: ["PepeWeird"],
    keywords: ["Weird", "Pepe", "peepo"],
  ...
  },
  {
    ...
    short_names: ["WHYY"],
    keywords: ["Sad", "Cry"],
    imageUrl: "/emotes/NOOO.png",
  },
  {
    name: "Susge",
    short_names: ["Sus"],
    keywords: ["Pepe", "peepo", "Among Us"],
    imageUrl: "/emotes/Susge.png",
  },
  {
    name: "Weirdge",
    short_names: ["Weird"],
  ...
  },
  {
    name: "PepeMods",
    short_names: ["Mods"],
    keywords: ["Pepe", "peepo", "Mod"],
    imageUrl: "/emotes/PepeMods.png",
  },
  {
    name: "BlackPog",
    short_names: ["BlackU"],
    keywords: ["Pog", "Amazed", "Surprised"],
    imageUrl: "/emotes/BlackU.png",
  },
  {
    name: "peepoChrist",
    short_names: ["PepeChrist"],
    keywords: ["Jesus", "God", "Pepe", "peepo"],
    imageUrl: "/emotes/peepoChrist.png",
  },
  {
    name: "Madge",
    short_names: ["Mad"],
    keywords: ["PepeMad", "peepoMad"],
    imageUrl: "/emotes/Madge.png",
  },
  {
    name: "PagMan",
    short_names: ["Pag"],
    keywords: ["PogMan", "PacMan", "Pog"],
    imageUrl: "/emotes/PagMan.png",
  },
  {
    name: "Jebaited",
    short_names: ["Baited"],
    keywords: ["Jebait", "Bait", "Tricked"],
    imageUrl: "/emotes/Jebaited.png",
  },
  {
    name: "3Head",
    short_names: ["3Head"],
    keywords: ["Dumb", "Head", "Brain"],
    imageUrl: "/emotes/3Head.png",
  },
  {
    name: "4House",
    short_names: ["4House"],
    keywords: ["House", "Head"],
    imageUrl: "/emotes/4House.png",
  },
  {
    name: "peepoHard",
    short_names: ["PepeHard"],
    keywords: ["Hard", "Pepe", "peepo"],
    imageUrl: "/emotes/peepoHard.png",
  },
  {
    name: "PepePains",
    short_names: ["Pains"],
    keywords: ["Pepe", "peepo", "Cringe"],
    imageUrl: "/emotes/PepePains.png",
  },
  {
    name: "4Heed",
    short_names: ["4Heed"],
    keywords: ["Head", "Laugh", "Haha"],
    imageUrl: "/emotes/4Heed.png",
  },
  {
    name: "AYAYAY",
    short_names: ["AYAYAY"],
    keywords: ["Mexico", "Mexican AYAYA", "AYAYA"],
    imageUrl: "/emotes/AYAYAY.png",
  },
  {
    name: "KKool",
    short_names: ["KKDance"],
    keywords: ["Dance", "Dancing", "KKona"],
    imageUrl: "/emotes/KKool.gif",
  },
  {
    name: "TriDance",
    short_names: ["TriKool"],
    keywords: ["Dance", "Dancing", "TriHard"],
    imageUrl: "/emotes/TriDance.gif",
  },
  {
    name: "heart",
    short_names: ["heart", "<3"],
